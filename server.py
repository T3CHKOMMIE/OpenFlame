    ...
    def do_GET(self):
        ...
        if path == "/api/posts":
            ...
            try:
                ...
                subprocess.Popen(
                    ["vcgencmd", "display_power", "0"])  # idont liek this maybe we do vcgencmd display_power 0?
                ser.write(b'logpower\r')
                print("Turning LED Off!")
                pixels1 = neopixel.NeoPixel(board.D18, 188, brightness=1)
                pixels1.fill((0, 0, 0))
